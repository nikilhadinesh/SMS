...
// import { Mail, Lock, User, LogIn, GraduationCap } from 'lucide-react'; // Icons import
...
//       if (user.role !== role) {
//         alert("Role mismatch! Please check your selection.");
//         return;
//       }
...
//           <select style={styles.select} onChange={(e) => setRole(e.target.value)} value={role}>
...
//   card: { padding: '40px', borderRadius: '15px', backgroundColor: '#fff', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', width: '350px' },
//   iconContainer: { textAlign: 'center', marginBottom: '20px' },
//   title: { textAlign: 'center', marginBottom: '20px', color: '#1f2937' },
//   inputGroup: { display: 'flex', alignItems: 'center', marginBottom: '15px', borderBottom: '2px solid #e5e7eb' },
//   inputIcon: { marginRight: '10px', color: '#6b7280' },
//   input: { border: 'none', padding: '10px', width: '100%', outline: 'none' },
//   select: { border: 'none', padding: '10px', width: '100%', outline: 'none', backgroundColor: 'transparent' },
//   button: { width: '100%', padding: '12px', marginTop: '15px', backgroundColor: '#4f46e5', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px' }
// };
